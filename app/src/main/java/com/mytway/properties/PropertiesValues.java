...
//    public static int RARELY_INTERVAL_REPEATS_TO_UPDATE_WIDGET = 1000 * 3600;// 1 hour
    ...
    public static final int MINUTES_FOR_WALK_TO_PLACE = 0; //4 should be, now 0 for testing // minutes will be added to start work time, to let user walk to office
    public static final int MINUTES_FOR_RECOGNITION_LEAVED_PLACE = 0;//2 should be, now 0 for testing// minutes will be deducted from recognition that user leaved home
